...
describe("svelte-prism-action", () => {
  ...
  it("it highlights inline code", () => {
    cy.visit("/").get("#test_inline").should("have.class", "language-bash");
  });

  it("it highlights block code wrapped in <pre>", () => {
    cy.visit("/").get("#test_block").should("have.class", "language-html");
  });

  it("adds dataset.isHighlighted", () => {
    cy.visit("/")
      .get("#test_inline")
      .should("have.attr", "data-is-highlighted", "true")
      .get("#test_block")
      .should("have.attr", "data-is-highlighted", "true");
  });
  ...
  it("include languages inside markdown", () => {
    cy.visit("/").get("#test_markdown").scrollIntoView();
  ...
  it("can load custom languages from prism plugin", () => {
    cy.visit("/")
      .get("#test_svelte")
      .scrollIntoView()
      .should("have.class", "language-svelte")
      .should("have.attr", "data-is-highlighted");
  });
});
